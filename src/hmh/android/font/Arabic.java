...
public final class Arabic {
    ...
    public static boolean isArabicConversionNeeded = true;
     ...
     * Alef private final static String szLamStickAndAlefWoosim = Character
     * .toString((char) 0x90) + Character.toString((char) 0xbb); // Lam //
     * (Sticky // !!!)+ // Alef private final static String szLaWoosim =
     * Character.toString((char) 0xd9); // La private final static String
     * szLaStickWoosim = Character .toString((char) 0xd9); // La
     */
    ...
    public static final String convertToRealArabic(String In) {
	String strOut = "";
    ...
    public static final Typeface getArabicFont(Context act) {
	if (typeface == null) {
