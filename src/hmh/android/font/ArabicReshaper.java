...
public class ArabicReshaper {
     ...
     * 
     * If "ا" It has only two forms : "ـا" and "ا" If "ب" It has
     * only four forms : "بـ", "ـبـ", "ـب" and "ب" and
     * so on
     */
	...
	for (int i = 1; i < wordLength - 1; i++) {
		...
		if (getGlphyTypeBefore(unshapedWord, i - 2) == 2) {
		    ...
		    reshapedLetters[i] = (char) getLamAlef(wordLetters[i],
			    currentLetter, true);
	...
	if (getLamAlef(wordLetters[wordLength - 1],
		...
		// Assign Lam Alef to the Letter of Alef
		reshapedLetters[wordLength - 1] = (char) getLamAlef(
